...
This space provides some sample data sample files collected:
  ...
  2. using the B210 USRP from Ettus research. At the time of data collection, we had four B210s in our pocession, each having four antenna slots (sections A and B, each having a Tx/Rx and an Rx antenna slot)
  3. by Jerome Arokkiam, as transmitted by commercial LTE and WiFi base stations.
